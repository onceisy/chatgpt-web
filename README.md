...
<div style="font-size: 1.5rem;">
  ...
  <a href="https://ai.onceisy.com/">[DEMO]国内服务器镜像（仅境内可访问）</a>
  <a href="https://ai.onceicu.com/">[DEMO]国外镜像（境内境外都可访问）</a>
  <a href="https://ai.once.cyou/">[DEMO]国外镜像（境内境外都可访问）</a>
</div>
</br>

本项目fork于：[chatgpt-web](https://github.com/Chanzhaoyu/chatgpt-web)
